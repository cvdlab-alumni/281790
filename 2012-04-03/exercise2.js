...
var create3DGlassWall = function(startPoint, endx, endy){
	var startx 	= startPoint[0];
	var starty 	= startPoint[1];
	var gwall = SIMPLEX_GRID([ [-startx,endx-startx], [-starty, endy-starty], [thick, wthick] ]);
	return gwall;
}
...
var fulltWalls = STRUCT([thickWall1, thickWall2, thickWall3, thickWall4, thickWall5, thickWall6, thickWall7, thickWall8, thickWall9, thickWall10, thickWall11]);
var fullnWalls = STRUCT([nwall1, nwall2, nwall3, nwall4, nwall5 ]);
var fullgWalls = STRUCT([glassw1, glassw2, glassw3, glassw4]);
var fullWalls = STRUCT([fulltWalls,fullnWalls,fullgWalls]);
...
var structure = STRUCT([fullFloor, fullWalls, fullRoofs, fullBPools]);
